                    ...
                    <h5 class="rating_order_num">
                        <section class="rating_order_num_left">
                            <section class="rating_section">
                                ...
                                <span class="rating_num">{{item.rating/100}}</span>
                            </section>
...
export default {
    ...
    methods: {
        ...
        async listenPropChange(){
            this.showLoading = true;
            this.offset = 0;
            let res = await shopList(this.latitude, this.longitude, this.decidedSchoolData.school_name, this.decidedSchoolData.school_campus_name, this.offset, '', this.restaurantCategoryIds, this.sortByType, this.deliveryMode, this.supportIds);
            this.hideLoading();
