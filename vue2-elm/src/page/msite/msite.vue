...
export default {
    data(){
        return {
            ...
            realAddrName: '', // geo对应的实际地址
            shopAddrName: '', // 根据数据库中学校/店铺信息计算出的 对应的shop地址
            decidedSchoolData: {}, // 根据数据库中学校/店铺信息计算出的 user 所在学校信息
    ...
    methods: {
        ...mapMutations([
            'RECORD_ADDRESS', 'SAVE_GEOHASH', 'SAVE_USER_DETAIL_ADDRESS'
        ]),
